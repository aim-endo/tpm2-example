...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        for (const auto& option : capability_options) {
            TPMS_CAPABILITY_DATA* data = nullptr;
            ...
            do {
                ...
                r = Esys_GetCapability(context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, option.capability, option.property, option.count - property_count, &has_more_data, &fetched);
